 ...
 * @author C0nacyt
 */
public class JPanelConsultoriasCatalog extends javax.swing.JDialog {
     ...
     * @param accion
     */
    public JPanelConsultoriasCatalog(java.awt.Frame parent, boolean modal, String accion) {
        super(parent, modal);
        initComponents();
        ...
        String sSQLConsulta = "SELECT "
                + "ID_consultoria, nombre_consultoria, estado_consultoria "
                + "FROM consultoria "
                + "ORDER BY consultoria.nombre_consultoria ASC";
    ...
    private void CargaDatos(String Cadena) {
        ...
        int Cont = 1;
        String[] titulos = {"ID", "CONSULTORÍA", "ESTATUS"};
        ...
        try {
            ...
            //----->  ID_consultoria, nombre_consultoria, estado_consultoria
            while (rs.next()) {
                registro[0] = rs.getString("ID_consultoria");
                registro[1] = rs.getString("nombre_consultoria");
                if (rs.getString("estado_consultoria").equals("0")) {
                    registro[2] = "INACTIVO";
                } else {
                    registro[2] = "ACTIVO";
                }
    ...
    private void GuardarRegistro() {
        ...
        if (accion.equals("NEW")) {
            //AGREGA NUEVO
            sentenciaSQL = "INSERT INTO consultoria (ID_consultoria, nombre_consultoria, estado_consultoria)"
                    + " VALUES (NULL, '" + siglas + "', '" + valueStatus + "')";
            ExecuteQuery(sentenciaSQL, "Nuevo registro");
            Hilo hilo = new Hilo(300, 30);
            hilo.agregarTexto("SE HA CREADO AGREGADO UNA NUEVA CONSULTORÍA", 1);
            hilo.start();
        } else {
            //ACTUALIZAR ELEMENOT
            sentenciaSQL = "UPDATE consultoria SET nombre_consultoria = '" + siglas + "', estado_consultoria = '" + valueStatus + "' "
                    + "WHERE consultoria.ID_consultoria = " + txtID.getText() + " ";
        ...
        lblTitulo.setText("Catalogo de Consultorías");
    ...
    private void CargarRegistro(String sSQL) {
        ...
        try {
            ...
            while (rs1.next()) {
                //ID_consultoria, nombre_consultoria, estado_consultoria
                Datos1[0] = rs1.getString("ID_consultoria");
                Datos1[1] = rs1.getString("nombre_consultoria");
                Datos1[2] = rs1.getString("estado_consultoria");
                conConsultor++;
            }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Catalogo de Consultorias");
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Información de la Consultoría", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 0, 18), new java.awt.Color(102, 102, 102))); // NOI18N
    ...
    private void TBLRegistrosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TBLRegistrosMouseClicked
        ...
        if (TBLRegistros.isEnabled()) {
            ...
            String sSQL = "SELECT ID_consultoria, nombre_consultoria, estado_consultoria "
                    + "FROM consultoria WHERE ID_consultoria = " + idCons + " ";
            CargarRegistro(sSQL);
        }
